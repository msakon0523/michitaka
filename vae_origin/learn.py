...
def main(_):
    ...
    data, data_num, data_shape, dir_num = read_images(FLAGS.data_dir)#data:ナンバリングされたimageとimage(rgb),data_num:35200, data_shape:64*64*3, 35200
    ...
    channel_list = [data_shape[2], 32, 32, 100, 20]#[2]=3
